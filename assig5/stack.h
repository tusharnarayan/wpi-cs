/* File stack.h
 * Contains structure definition for the stack.
 * Also has prototypes for stack functions.
...
typedef struct stack Stack; // for convenience
 ...
 * @param which_stack Pointer to Stack structure that has to be deleted.
 */
