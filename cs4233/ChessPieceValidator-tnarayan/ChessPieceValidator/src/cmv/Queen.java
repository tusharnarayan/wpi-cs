...
/**
 * A class that contains the information needed for the Queen chess piece.
 * 
 * @version Sep 1, 2014
 * 
 * @author tnarayan
...
public class Queen extends ChessPiece {
	...
	public Queen(ChessPlayerColor color) {
		super(cmv.ChessPieceType.QUEEN, color);
	}
	 ...
	 * 
	 * This method determines whether the queen can move from the specified
	 ...
	 * 
	 * The queen's move is legal if it is either:
	 * <ul>
	 * <li>a valid vertical move (no change in columns), or</li>
	 * <li>a valid horizontal move (no change in rows), or</li>
	 * <li>a valid diagonal move.</li>
	 * </ul>
	 * </p>
	 */
	@Override
	public boolean isMoveLegal(char fromColumn, int fromRow, char toColumn, int toRow) {
		...
		if (isValidDiagonalMove(fromColumn, fromRow, toColumn, toRow))return true;
